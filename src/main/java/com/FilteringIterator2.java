 ...
 *
 * Second approach, much better since it does use the same iterator instance
 */
public class FilteringIterator2<T> implements Iterator<T> {

	private Iterator<T> myIterator;
	private IObjectTest<T> myTest;
	private T nextElement;

	public FilteringIterator2(Iterator<T> myIterator, IObjectTest<T> myTest) {
		super();
